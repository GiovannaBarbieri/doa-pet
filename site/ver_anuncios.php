                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            ...
                            <select class="form-control" id="tipo_porte" name="tipo_porte">
                                ...
                                <button class="btn btn-info" name="btn_pesquisar">Pesquisar</button> <a href="http://doapet.com.br/site/ver_anuncios.php">Limpar</a>
...
<div class="col-md-10 ">
                    ...
                    <div class="col-md-2" style="position: sticky;top: 20px;margin-top: 20px;">
                         <?php include './banner_anuncio_direita.php'; ?>
                     </div>
